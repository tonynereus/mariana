...
const Products = () => {
  ...
  useEffect(() => {
    const fetchAllProducts = async () => {
      try {
        if (isFragBoolean) {
          apiUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/site/fragrance-products/all-products`;
        } else {
          apiUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/site/category-products/all-products`;
        }
